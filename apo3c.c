...
#if 0
/*
for George Cotton WB5JJJ

EEPROM table for LVD, LVR, off delay, and serial number
generated by the following command:
./apo3c_table 11.8 12.1 12.7 13.05 12.4 12.3 12.9 13.4 1 1800 3600 5400
*/
#rom 0x2100 = {
        0x02, 0xf2, 0x03, 0x05, 0x03, 0x2c, 0x03, 0x42, /* LVD = { 11.80 12.10 12.70 13.05 } volts */
        0x03, 0x18, 0x03, 0x12, 0x03, 0x38, 0x03, 0x58, /* LVR = { 12.40 12.30 12.90 13.40 } volts */
        0x00, 0x01, 0x07, 0x08, 0x0e, 0x10, 0x15, 0x18, /* OFF DELAY = { 1 1800 3600 5400 } seconds */
        0x00, 0x00, 0x00, 0x01 } /* SERIAL NUMBER is always 1 */

#endif

#if 0
/* CIC PowerBox 2020 Version per Andrew's e-mail on 2020-07-09 */
/*
EEPROM table for LVD, LVR, off delay, and serial number
generated by the following command:
apo3c_table 12.1 12.7 13.05 13.5 12.3 12.9 13.4 14.0 1 60 120 300
*/
#rom 0x2100 = {
        0x03, 0x05, 0x03, 0x2c, 0x03, 0x42, 0x03, 0x5f, /* LVD = { 12.10 12.70 13.05 13.50 } volts */
        0x03, 0x12, 0x03, 0x38, 0x03, 0x58, 0x03, 0x7f, /* LVR = { 12.30 12.90 13.40 14.00 } volts */
        0x00, 0x01, 0x00, 0x3c, 0x00, 0x78, 0x01, 0x2c, /* OFF DELAY = { 1 60 120 300 } seconds */
        0x00, 0x00, 0x00, 0x01 } /* SERIAL NUMBER is always 1 */ 
...
#if 0
/* CIC PowerBox 2020 Version per Andrew's e-mail on 2020-07-30 */
/*
EEPROM table for LVD, LVR, off delay, and serial number
generated by the following command:
apo3c_table 12.7 13.05 13.3 13.5 12.9 13.4 13.7 14.0 10 20 60 120
*/
#rom 0x2100 = {
         0x03, 0x2c, 0x03, 0x42, 0x03, 0x52, 0x03, 0x5f, /* LVD = {
12.70 13.05 13.30 13.50 } volts */
         0x03, 0x38, 0x03, 0x58, 0x03, 0x6b, 0x03, 0x7f, /* LVR = {
12.90 13.40 13.70 14.00 } volts */
         0x00, 0x0a, 0x00, 0x14, 0x00, 0x3c, 0x00, 0x78, /* OFF DELAY =
{ 10 20 60 120 } seconds */
         0x00, 0x00, 0x00, 0x01 } /* SERIAL NUMBER is always 1 */
#endif

#if 0
/* CIC PowerBox 2020 version per Andrew's e-mail on 2020-10-29 */
/*
EEPROM table for LVD, LVR, off delay, and serial number
generated by the following command:
apo3c_table 13.05 13.15 13.25 13.35 13.40 13.50 13.60 13.70 1 60 120 300
*/
#rom 0x2100 = {
         0x03, 0x42, 0x03, 0x48, 0x03, 0x4f, 0x03, 0x55, /* LVD = {
13.05 13.15 13.25 13.35 } volts */
         0x03, 0x58, 0x03, 0x5f, 0x03, 0x65, 0x03, 0x6b, /* LVR = {
13.40 13.50 13.60 13.70 } volts */
         0x00, 0x01, 0x00, 0x3c, 0x00, 0x78, 0x01, 0x2c, /* OFF DELAY =
{ 1 60 120 300 } seconds */
         0x00, 0x00, 0x00, 0x01 } /* SERIAL NUMBER is always 1 */
#endif

#if 0
/* CIC PowerBox 2022 12/24V version per Andrew's e-mail on 2022-04-12 */
/*
EEPROM table for LVD, LVR, off delay, and serial number
generated by the following command:
apo3c24_table 13.05 13.15 13.25 13.35 13.40 13.50 13.60 13.70 1 60 120 300
*/
#rom 0x2100 = {
        0x01, 0xbd, 0x01, 0xc1, 0x01, 0xc4, 0x01, 0xc7, /* LVD = { 13.05 13.15 13.25 13.35 } volts */
        0x01, 0xc9, 0x01, 0xcd, 0x01, 0xd0, 0x01, 0xd3, /* LVR = { 13.40 13.50 13.60 13.70 } volts */
        0x00, 0x01, 0x00, 0x3c, 0x00, 0x78, 0x01, 0x2c, /* OFF DELAY = { 1 60 120 300 } seconds */
        0x00, 0x00, 0x00, 0x02 } /* SERIAL NUMBER is always 2 for APO3C24 */
#endif
